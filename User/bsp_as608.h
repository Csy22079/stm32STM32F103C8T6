...
#define  AS608_USART_CLK                RCC_APB1Periph_USART3
#define  AS608_USART_APBxClkCmd         RCC_APB1PeriphClockCmd
#define  AS608_USART_BAUDRATE           57600

/*USART GPIO 引脚宏定义*/
#define  AS608_USART_GPIO_CLK           (RCC_APB2Periph_GPIOB)
#define  AS608_USART_GPIO_APBxClkCmd    RCC_APB2PeriphClockCmd
    
#define  AS608_USART_TX_GPIO_PORT       GPIOB  
#define  AS608_USART_TX_GPIO_PIN        GPIO_Pin_10
#define  AS608_USART_RX_GPIO_PORT       GPIOB
#define  AS608_USART_RX_GPIO_PIN        GPIO_Pin_11

#define  AS608_USART_IRQ                USART3_IRQn
